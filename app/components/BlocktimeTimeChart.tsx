...
import { getBlocktimeTimeSeries } from "../../lib/database";
...
export function BlocktimeChart() {
  ...
  React.useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        const data24h = await getBlocktimeTimeSeries(start24h, endTime);
        const dataAll = await getBlocktimeTimeSeries(startAll, endTime);
        ...
        console.error("Error fetching blocktime data:", error);
      }
    };
